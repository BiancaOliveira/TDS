...
//                Logger.getLogger(CargoDAO.class.getName()).log(Level.SEVERE,null,ex);
     ...
     * @throws java.sql.SQLException    Exeções Sql
     */
     private static UsuarioAdm getInstance(int idLogin)  throws SQLException, BancoException, ClassNotFoundException {
...
//                Logger.getLogger(UsuarioAdmDAO.class.getName()).log(Level.SEVERE,null,ex);
    ...
    /**
     * Lista todos os UsuarioAdm na tabela Adiministrador atravez do usuario(login)
     * na tabela Usuario e do cargo na tabela Cargo
    ...
    /**
     * Busca por usuario um UsuarioAdm na tabela Adiministrador atravez do Usuario
     * na tabela Usuario e do cargo na tabela Cargo
...
//                Logger.getLogger(UsuarioAdmDAO.class.getName()).log(Level.SEVERE,null,ex);
    ...
    /**
     * Busca por id um UsuarioaAdm na tabela Administrado 
    ...
    /**
     * Busca por nome(parte ) UsuarioAdm na tabela Adiministrador 
