...
//
//          controleAdm.cadastrar(0,"QuVero","muCito","morrer","AdmiVCXnistrador");
...
//          controleFun.cadastrar(0,"testCVe","te","ters","AdminiVCstrador");
//        
//        //listar Cargos
...
//        
//
//          controleLiv.cadastrar(0,"DSterte",23,"dsadsa", "bart" ,"testSDAe","terror","bart");
//          controleLiv.cadastrar(0,"saDSdsa terte dfdaf",23,"dsadsa", "bart" ,"teste","terror","bart");
////        
//        //listar Cargos
...
//        }
        ...
        controleEmpre.cadastrar(0,formato.format(dataEmprestimo),formato.format(dataDevolucao),"DSterte","muito",true);     
        //listar Cargos
        System.out.println("Lista : " + controleEmpre.listar());
        //busca cargo pelo login
        System.out.println("Buscar : " + controleEmpre.buscar("DSterte"));
//        controleEmpre.remover(controleEmpre.buscar(0));
//    }
    }
}
